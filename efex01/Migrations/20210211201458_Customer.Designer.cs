...
namespace efex01.Migrations
{
    ...
    [Migration("20210211201458_Customer")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("efex01.Models.Order", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("efex01.Models.OrderLine", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("efex01.Models.OrderLine", b =>
                {
                    b.HasOne("efex01.Models.Order", "Order")
                        .WithMany("Lines")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("efex01.Models.Product", "Product")
                        .WithMany()
